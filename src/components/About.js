...
const About = () => {
    return (
        <div style={{ color: '#333', backgroundColor: '#f9f9f9', padding: '20px', borderRadius: '10px' }}>
            <h2 style={{ color: '#007bff' }}>About iNotebook:</h2>
            <p>
            ...
            <h3 style={{ color: '#007bff' }}>Why Choose iNotebook?</h3>
            <ul>
